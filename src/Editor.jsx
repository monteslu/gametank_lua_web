...
const SIGNATURES = {
  ...
  "gt.phys_bounds": ["(x0, y0, x1, y1, bounce_min)", "the walls balls bounce in (default: whole screen); bounce_min = fall speed needed to bounce off the floor (0 = always, higher = balls settle)"],
  ...
  "gt.phys_draw": ["(x, y, cells, n)", "draw the ball table (16x16 blits in bulk asm)"],
